...
export const IndexHL7:any = {  // https://csvjson.com/json2csv
    ...
    ValueSet: {   // SYSTEM and CODES
        IPS: {
            SYSTEM: "",
            CODES: []
        },
        IDENTIFIER_TYPE: {  // This an exception, instead of CODES it has CATEGORY with CODES within each category
            VALUE_SET: "http://hl7.org/fhir/ValueSet/identifier-type", // CAUTION: use SYSTEM and not VALUE_SET
        ...
        DIAGNOSTIC_SERVICE_SECTIONS:  {
            ...
            SYSTEM: "http://terminology.hl7.org/CodeSystem/v2-0074",    // CAUTION: use use SYSTEM and not VALUE_SET for the hl7.json file
        ...
        DEVICE_SAFETY: {
            ...
            SYSTEM: "http://hl7.org/fhir/ValueSet/device-safety",   // CAUTION: use SYSTEM and not VALUE_SET for the hl7.json file
            CODES: ["C106038","C101673","C113844","C106047","C106045","C106046"]
        },
        VaccineCode: {
            SYSTEM: "http://hl7.org/fhir/sid/cvx",   // CAUTION: use SYSTEM and not VALUE_SET for the hl7.json file
...
export function translateCodesHL7(codes: string[], codeslabels:any, labelKeySection?: string): string[] {  
