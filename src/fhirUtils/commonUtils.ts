...
import { validate, version, v4, parse as uuidParse } from "uuid"
const BASE64_ALPHABET = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'

// const sortObjKeysAlphabetically = (obj:object) => Object.keys(Object.entries(obj).sort());

export function sortStringsByAlphabet(a:string, b:string): any {
    ...
    if (object !== null && typeof object === "object") {
        ...
        .reduce((result: any, key: string) => {
            ...
            if (Array.isArray(result[key])) {
                result[key] = result[key].map((obj: any) => sortObject(obj));
            }
...
export function validateUUIDv4(uuidv4:string): boolean{
