...
import { createBundleDocumentWithComposition } from "../../src/utils/bundle"
...
describe("test FHIR Bundle of type Message", () => {
    ...
    // errors with resources.filter is not a function at Object.getResources (src/utils/fhirBundleUtils.ts:453:35): let results:any[] = resources.filter( function(resource){

    it("should create a FHIR Message", async (done) => {
        // Not necessary: It creates a Bundle document from an observation       
        const healthDocument = createBundleDocumentWithComposition([observationForTesting]) as any
