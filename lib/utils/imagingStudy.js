...
import { v4 } from "uuid";
export function createImagingStudy(subject, idValue, idSystem, series) {
...
export function createSerie(modalityCode, uid, number, instances) {
    let modalityCoding = {
...
export function addSeriesToStudy(fhirStudy, fhirSeries) {
...
export function createInstance(instanceUID, sopClassUID, number, title) {
    let sopClassCoding = {
...
export function addInstancesToSerie(fhirSerie, fhirinstances) {
...
export function createImagingStudiesByDicomdirContent(subjectId, dicomdirPatients) {
