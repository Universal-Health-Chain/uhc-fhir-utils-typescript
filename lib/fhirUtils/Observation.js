...
function createBloodTypingMainBundleFHIR(authorIdOrURN, authorType) {
    ...
    return Bundle_1.createBundleDocumentWithTypeLOINC(authorReferenceURN, Loinc_1.medicalHistoryClassification.diagnosticResults, [mainBloodTypingObservation]);
}
