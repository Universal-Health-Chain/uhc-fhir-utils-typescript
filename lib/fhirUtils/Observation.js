...
function createBloodTypingMainBundleFHIR() {
    ...
    let bundle = Bundle_1.createBundleDocumentWithComposition([mainBloodTypingObservation]);
    return bundle;
}
