...
exports.getMediaInBundle = exports.replaceResourceById = exports.getObservationsByCode = exports.getResourceByIdInBundle = exports.getResourcesByTypes = exports.getResourceReferencesBySectionCodeLOINC = exports.getResourceIdsInBundle = exports.getAllResourcesWithoutCompositionOrMessageHeader = exports.getAllResourcesInBundle = exports.getResourcesInSection = exports.getReferencesInSection = exports.addEntriesBySection = exports.addResourcesBySection = exports.addEntriesToBundle = exports.createEmptyIPS = exports.hasSections = exports.getDocumentKindInComposition = exports.isIPS = exports.createBundleDocumentWithComposition = exports.addResourcesToBundle = exports.addResourceToBundle = exports.getTagsInBundleResource = exports.isCovid19SoleResource = exports.getTimestamp = exports.getCleanIdOfDocumentComposition = exports.getSectionCodeForResourceIdInBundle = exports.getResourcesWithFilters = exports.getResourceWithOptionalMetaData = exports.addOptionalMetaDataToResource = exports.Bundle = void 0;
...
class Bundle {
    ...
    getDocumentKindInComposition(bundleDocument) {
    ...
    getCodesOfSections(bundleDocument) {
        ...
        if (compositions && compositions.length && compositions.length > 0) {
            return Composition_1.getCodesOfSections(compositions[0].section, models_1.CodingSystem.loinc);
        }
        else {
            return []; // empty
        }
...
// ---- FUNCTIONS ----
// -------------------
function addOptionalMetaDataToResource(fhirResource, fhirBundle, defaultSectionLOINC, defaultServiceType) {
...
exports.addOptionalMetaDataToResource = addOptionalMetaDataToResource;
...
function isCovid19SoleResource(resource) {
    if (resource && resource.resourceType) {
        let codesCovid19 = [];
        switch (resource.resourceType) {
            case ("Immunization"): {
                // It checks for all COVID-19 vaccine codes (CVX and ATC) and put uhcTagForCovid19 value if some was found
                codesCovid19 = CodeableConcept_1.addExistingTargetCodesInCodeableConcepts([resource.vaccineCode], Covid19_1.covid19VaccineProphylaxisCodesGlobal(), codesCovid19);
...
exports.isCovid19SoleResource = isCovid19SoleResource;
/** Bundle type can be document, collection, message, history... */
function getTagsInBundleResource(bundleDocument) {
    const tagCovid19 = Covid19_1.covid19Tag;
    let uhcCodeTags = ["Bundle"];
    let resources = getAllResourcesInBundle(bundleDocument);
...
exports.getTagsInBundleResource = getTagsInBundleResource;
...
exports.isIPS = isIPS;
// the first resource type in the bundle document must be a composition: http://hl7.org/fhir/bundle.html
function getDocumentKindInComposition(bundleDocument) {
...
exports.getDocumentKindInComposition = getDocumentKindInComposition;
...
function getAllResourcesWithoutCompositionOrMessageHeader(fhirBundle) {
