...
class Bundle {
    ...
    createEmptyIPS(authorReferenceId) {
        ...
        return createBundleDocumentWithTypeLOINC(authorReferenceId, Loinc_1.medicalHistoryClassification.ips);
    }
 ...
 * It sets by default the status as 'preliminary',  the title as `${typeDocumentDisplay} (${date})`
 * and the type of document composition as '11503-0' (generic 'Medical records') if not provided */
function createBundleDocumentWithTypeLOINC(authorReferenceId, typeDocumentCodeLOINC, resources) {
    ...
    return createBundleDocumentAndCompositionWithIds(bundleDocumentURN, documentCompositionURN, authorReferenceId, datetime, title, ts_fhir_types_1.R4.CompositionStatusKind._preliminary, typeDocumentCodeLOINC, models_1.CodingSystem.loinc, typeDocumentDisplay, undefined, resources);
}
exports.createBundleDocumentWithTypeLOINC = createBundleDocumentWithTypeLOINC;
/** It create Bundle Document and Composition with URNs
 * It sets by default the status as 'preliminary' and the title as `${typeDocumentDisplay} (${date})` */
 ...
 * TODO: generate the entry.fullUrl and reference as "resourceType/id"
 */
function addResourcesBySection(bundleDocument, sectionCode, resources, excludeResources) {
    ...
    let newComposition = Composition_1.addResourcesToComposition(composition, resources, sectionCode);
