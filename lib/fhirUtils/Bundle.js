...
class Bundle {
    ...
    createBundleDocumentAndCompositionWithIds(bundleId, compositionId, authorId, authorType, date, title, status, typeDocumentCode, typeDocumentSystem, typeDocumentDisplay, language, resources, excludeResources) {
        return createBundleDocumentAndCompositionWithIds(bundleId, compositionId, authorId, authorType, date, title, status, typeDocumentCode, typeDocumentSystem, typeDocumentDisplay, typeDocumentDisplay, resources, excludeResources);
    }
} // end class Bundle
...
/** Creates a Bundle document with all mandatory properties in the document 'Composition' resource (the index) */
function createBundleDocumentAndCompositionWithIds(bundleId, compositionId, authorIdOrURI, authorType, date, title, status, typeDocumentCode, typeDocumentSystem, typeDocumentDisplay, language, resources, excludeResources) {
    // console.log(`createBundleDocumentWithCompositionAndURNs with ${resources.length} resources`)
    let basicComposition = Composition_1.createCompositionWithId(compositionId, authorIdOrURI, authorType, date, title, status, typeDocumentCode, typeDocumentSystem, typeDocumentDisplay, language);
