...
import { vaccineCodesCovid19, covid19Tag, covid19LaboratoryTestsAndGroupsCodes } from "./Covid19";
export class Bundle {
    constructor() {
    }
...
export function getTagsOfBundleDocument(bundleDocument) {
    const tagCovid19 = covid19Tag;
    let uhcCodeTags = [];
...
export function createEmptyIPS(authorReferenceId) {
    let typeDocumentCodeLOINC = GlobalIndexLOINC.categorization.healthSection.compositionIPS;
