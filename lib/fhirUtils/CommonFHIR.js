...
export function classifyBundleByResourceTypes(fhirDocument) {
...
export function fhirNormalization(fhirResource) {
...
export function getLabelsOfGroupedCodes(codes, hl7LanguageFile, targetGroupedSection) {
