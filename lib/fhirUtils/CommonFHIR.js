...
export function getLabelsOfGroupedCodes(codes, codeLabels, groupedSectionName) {
...
export function getDisplayCode(code, englishCodeLabels) {
    let codes = getLabelsOfGroupedCodes([code], englishCodeLabels);
    return codes[0];
}
export function getLocalizedTextCode(code, localizedCodeLabels) {
    let codes = getLabelsOfGroupedCodes([code], localizedCodeLabels);
    return codes[0];
}
/*
// TODO:
