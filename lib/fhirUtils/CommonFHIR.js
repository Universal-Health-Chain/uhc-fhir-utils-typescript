...
exports.getLabelsOfGroupedCodes = exports.anonymizeResource = exports.normalizedAndCanonicalizedFHIR = exports.getBundleEntriesMap = exports.getCleanIdByFhirResource = exports.getCleanId = exports.CommonFHIR = exports.ANONYMIZATION = exports.FHIR_INSTANT_REGEX = exports.FHIR_DATETIME_REGEX = exports.FHIR_DATE_REGEX = exports.BLOOD_TYPING_MAIN_CODE_TEXT = exports.UrnPrefixFHIR = void 0;
...
*/
var UrnPrefixFHIR;
(function (UrnPrefixFHIR) {
    UrnPrefixFHIR["BundleDocument"] = "URN:FHIR:DOCUMENT:";
    UrnPrefixFHIR["DocumentComposition"] = "URN:FHIR:COMPOSITION:";
    UrnPrefixFHIR["Attachment"] = "URN:FHIR:ATTACHMENT:";
    UrnPrefixFHIR["DocumentReference"] = "URN:FHIR:DOCUMENTREFERENCE:";
    UrnPrefixFHIR["Immunization"] = "URN:FHIR:IMMUNIZATION:";
    UrnPrefixFHIR["DiagnosticReport"] = "URN:FHIR:DIAGNOSTICREPORT:";
    UrnPrefixFHIR["Observation"] = "URN:FHIR:OBSERVATION:";
    UrnPrefixFHIR["VitalSign"] = "URN:FHIR:VITALSIGN:";
})(UrnPrefixFHIR = exports.UrnPrefixFHIR || (exports.UrnPrefixFHIR = {}));
...
class CommonFHIR {
    constructor() {
        ...
        this.getCleanId = (id) => getCleanId(id);
        this.getCleanIdByFhirResource = (resource) => getCleanIdByFhirResource(resource);
...
exports.getCleanId = getCleanId;
/** it gets a single ID from a FHIR reference URI or URN, among others */
function getCleanIdWithoutReferenceFHIROrURN(referenceOrURN) {
...
*/
function getCleanIdByFhirResource(resource) {
    try {
...
exports.getCleanIdByFhirResource = getCleanIdByFhirResource;
