...
exports.getLabelsOfGroupedCodes = exports.anonymizeResource = exports.fhirNormalization = exports.classifyBundleByResourceTypes = exports.CommonFHIR = exports.ANONYMIZATION = exports.FHIR_INSTANT_REGEX = exports.FHIR_DATETIME_REGEX = exports.FHIR_DATE_REGEX = exports.BLOOD_TYPING_MAIN_CODE_TEXT = void 0;
...
class CommonFHIR {
    constructor() {
        this.classifyBundleByResourceTypes = (fhirDocument) => classifyBundleByResourceTypes(fhirDocument);
    }
...
function classifyBundleByResourceTypes(fhirDocument) {
...
exports.classifyBundleByResourceTypes = classifyBundleByResourceTypes;
function fhirNormalization(fhirResource) {
    const NORMALIZATION = ["meta", "contained", "id", "text"];
    NORMALIZATION.forEach((key) => {
        delete fhirResource[key];
    });
    return commonUtils.sort.sortObject(fhirResource);
}
exports.fhirNormalization = fhirNormalization;
