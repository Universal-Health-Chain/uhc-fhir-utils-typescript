...
export class Hl7 {
    ...
    getDisplayCodeHl7(code, englishCodeLabels) {
...
(function (GroupedHL7) {
    ...
    GroupedHL7["organizationTypes"] = "organizationTypes";
})(GroupedHL7 || (GroupedHL7 = {}));
export function getDisplayCodeHl7(code, englishCodeLabels) {
    if (!englishCodeLabels)
        englishCodeLabels = require("../../languages/en/hl7UHC.json");
