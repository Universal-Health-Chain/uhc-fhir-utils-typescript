...
const UtilsModels_1 = require("../models/UtilsModels");
...
exports.GlobalIndexFHIR = {
    ...
    groupedCodes: {
        identifierBusiness: {
            codes: ["TAX", "PRN"],
            system: UtilsModels_1.CodingSystem.identifierBusiness
        },
        identifierPersonal: {
            codes: ["NN", "DL", "HC", "JHN", "SB", "PPN", "PRC", "SP", "WP"],
            system: UtilsModels_1.CodingSystem.identifierPersonal
        },
        identiferPatient: {
            codes: ["DR", "MA", "MC", "MR", "PI", "SS", "PIN"],
            system: UtilsModels_1.CodingSystem.identiferPatient
        },
        identifierProfessional: {
            codes: ["MD", "RN", "RPH", "TRL", "UPIN"],
            system: UtilsModels_1.CodingSystem.identifierProfessional
        },
        identifierGeneral: {
            codes: ["RI"],
            system: UtilsModels_1.CodingSystem.identifierGeneral
        },
        diagnosticServiceSections: {
            ...
            system: UtilsModels_1.CodingSystem.diagnosticServiceSections
        },
        deviceSafety: {
            codes: ["C106038", "C101673", "C113844", "C106047", "C106045", "C106046"],
            system: UtilsModels_1.CodingSystem.deviceSafety
        },
        cvx: {
            ...
            system: UtilsModels_1.CodingSystem.cvx
        },
        cvxCovid19: {
            codes: ["207", "208", "210"],
            system: UtilsModels_1.CodingSystem.cvxCovid19
        },
        communicationCategory: {
            codes: ["alert", "notification", "reminder", "instruction"],
            system: UtilsModels_1.CodingSystem.communicationCategory
        },
        eventStatus: {
            codes: ["preparation", "in-progress", "completed", "not-done", "on-hold", "stopped", "entered-in-error", "unknown"],
            system: UtilsModels_1.CodingSystem.eventStatus
        },
        organizationType: {
            codes: ["prov", "dept", "bus", "ins", "govt", "cg", "edu", "pay", "team", "reli", "crs", "other"],
            system: UtilsModels_1.CodingSystem.organizationType
        },
        vaccineManufacturer: {
            codes: [
