...
class Composition {
    ...
    createDefaultComposition(authorIdOrURI, authorType, typeDocumentCodeLOINC, id) {
...
*/
function createDefaultComposition(authorIdOrURI, authorType, typeDocumentCodeLOINC, typeDocumentDisplay, idOrURN, status, language) {
    ...
    return createCompositionWithId(idOrURN, authorIdOrURI, authorType, date, title, status, typeDocumentCodeLOINC, models_1.CodingSystem.loinc, typeDocumentDisplay, language);
}
...
function createCompositionWithId(idOrURN, authorIdOrURI, authorType, date, title, status, typeDocumentCode, typeDocumentSystem, typeDocumentDisplay, language) {
    let authorReference = {};
...
function createEmptyCompositionIPS(idOrURN, authorIdOrURI, authorType, date, status, title, language) {
    if (!title) {
        title = `Patient Summary (${date})`;
    }
    return createCompositionWithId(idOrURN, authorIdOrURI, authorType, date, title, status, Loinc_1.medicalHistoryClassification.ips, models_1.CodingSystem.loinc, 'Patient summary Document', language);
}
// TODO: put display and text of the section (translation)
