...
class Composition {
    ...
    createDefaultComposition(authorType, authorId, authorURI, authorDisplay, typeDocumentCodeLOINC, id) {
...
*/
function createDefaultComposition(authorType, authorId, authorURI, authorDisplay, typeDocumentCodeLOINC, typeDocumentDisplay, idOrURN, status, language) {
    ...
    return createCompositionWithIdAndAuthor(idOrURN, authorType, date, title, status, typeDocumentCodeLOINC, models_1.CodingSystem.loinc, typeDocumentDisplay, authorId, authorURI, authorDisplay, language);
}
...
function createCompositionWithIdAndAuthor(idOrURN, authorType, date, title, status, typeDocumentCode, typeDocumentSystem, typeDocumentDisplay, authorId, authorURI, authorDisplay, language) {
    let authorReference = {};
    /*
    if (authorIdOrURI &&
...
exports.createCompositionWithIdAndAuthor = createCompositionWithIdAndAuthor;
/** Title example: "Patient Summary as of December 11, 2017 14:30". TODO: if not title, generate it automatically */
function createEmptyCompositionIPS(idOrURN, authorType, date, status, title, authorId, authorURI, authorDisplay, language) {
    if (!title) {
        title = `Patient Summary (${date})`;
    }
    return createCompositionWithIdAndAuthor(idOrURN, authorType, date, title, status, Loinc_1.medicalHistoryClassification.ips, models_1.CodingSystem.loinc, 'Patient summary Document', authorId, authorURI, authorDisplay, language);
}
// TODO: put display and text of the section (translation)
