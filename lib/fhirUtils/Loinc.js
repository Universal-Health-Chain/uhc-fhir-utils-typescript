...
exports.GlobalIndexLOINC = exports.getFullNaatTestCovid19LOINC = exports.getFullSerologyTestCovid19LOINC = exports.getActiveLaboratoryTestsCovid19 = exports.getCovid19HealthCertificateLaboratoryTests = exports.getDisplayOrTextByCodeLOINC = exports.GroupedLOINC = exports.covid19HealthCertificateLaboratoryTest = exports.covid19LaboratoryTestGroups = exports.terminologyCodesLOINC = exports.medicalHistoryClassification = exports.Loinc = void 0;
// covid19 related method are in the specific class
class Loinc {
    constructor() {
        this.aboRhCodeLOINC = () => terminologyCodesLOINC.aboRH;
        // display code SHALL ALWAYS BE English (international)
        this.getDisplayOrTextByCodeLOINC = (code, loincLanguageFile) => getDisplayOrTextByCodeLOINC(code, loincLanguageFile);
        this.healthSections = () => exports.GlobalIndexLOINC.groupedCodes.healthSection.codes;
        this.laboratoryTestTopCommonSI = () => exports.GlobalIndexLOINC.groupedCodes.laboratoryTestTopCommonSI.codes;
...
exports.Loinc = Loinc;
var medicalHistoryClassification;
(function (medicalHistoryClassification) {
    medicalHistoryClassification["ips"] = "60591-5";
    medicalHistoryClassification["allergies"] = "48765-2";
    medicalHistoryClassification["vitalSigns"] = "8716-3";
    medicalHistoryClassification["problemList"] = "11450-4";
    medicalHistoryClassification["pastProblems"] = "11348-0";
    medicalHistoryClassification["familyDiseases"] = "10157-6";
    medicalHistoryClassification["medication"] = "10160-0";
    medicalHistoryClassification["immunization"] = "11369-6";
    medicalHistoryClassification["procedures"] = "47519-4";
    medicalHistoryClassification["diet"] = "61144-2";
    medicalHistoryClassification["diagnosticResults"] = "30954-2";
    medicalHistoryClassification["radiologyStudies"] = "18726-0";
    medicalHistoryClassification["medicalDevices"] = "46264-8";
    medicalHistoryClassification["socialHistory"] = "29762-2";
    medicalHistoryClassification["mentalStatus"] = "10190-7";
    medicalHistoryClassification["functionalStatus"] = "47420-5";
    medicalHistoryClassification["planOfCare"] = "18776-5";
    medicalHistoryClassification["pregnancy"] = "82810-3";
    medicalHistoryClassification["symptoms"] = "10187-3";
    medicalHistoryClassification["outpatient"] = "46240-8";
    medicalHistoryClassification["advanceDirectives"] = "42348-3";
    // goals
    // clinicalNotes
    medicalHistoryClassification["defaultMedicalRecords"] = "11503-0"; // "Medical records"
})(medicalHistoryClassification = exports.medicalHistoryClassification || (exports.medicalHistoryClassification = {}));
// export const HealthSectionCode = medicalHistoryClassification
var terminologyCodesLOINC;
(function (terminologyCodesLOINC) {
    terminologyCodesLOINC["serologyTestsGroup"] = "LG51018-6";
    terminologyCodesLOINC["naatTestsGroup"] = "LG51017-8";
    terminologyCodesLOINC["aboRH"] = "882-1"; // https://loinc.org/882-1/
})(terminologyCodesLOINC = exports.terminologyCodesLOINC || (exports.terminologyCodesLOINC = {}));
var covid19LaboratoryTestGroups;
(function (covid19LaboratoryTestGroups) {
    covid19LaboratoryTestGroups["serologyTestsGroup"] = "LG51018-6";
    covid19LaboratoryTestGroups["naatTestsGroup"] = "LG51017-8";
})(covid19LaboratoryTestGroups = exports.covid19LaboratoryTestGroups || (exports.covid19LaboratoryTestGroups = {}));
var covid19HealthCertificateLaboratoryTest;
(function (covid19HealthCertificateLaboratoryTest) {
    covid19HealthCertificateLaboratoryTest["RAT"] = "LP217198-3";
    covid19HealthCertificateLaboratoryTest["NAT"] = "LP6464-4";
})(covid19HealthCertificateLaboratoryTest = exports.covid19HealthCertificateLaboratoryTest || (exports.covid19HealthCertificateLaboratoryTest = {}));
...
})(GroupedLOINC = exports.GroupedLOINC || (exports.GroupedLOINC = {}));
// display code SHALL ALWAYS BE English (international)
function getDisplayOrTextByCodeLOINC(code, loincLanguageFile) {
    if (!loincLanguageFile)
        loincLanguageFile = require("../../languages/international/loincUHC.json");
    return loincLanguageFile[code];
}
exports.getDisplayOrTextByCodeLOINC = getDisplayOrTextByCodeLOINC;
function getCovid19HealthCertificateLaboratoryTests() {
    return [covid19HealthCertificateLaboratoryTest.NAT, covid19HealthCertificateLaboratoryTest.RAT];
}
exports.getCovid19HealthCertificateLaboratoryTests = getCovid19HealthCertificateLaboratoryTests;
function getActiveLaboratoryTestsCovid19() {
    return [...getFullSerologyTestCovid19LOINC(), ...getFullNaatTestCovid19LOINC()];
}
exports.getActiveLaboratoryTestsCovid19 = getActiveLaboratoryTestsCovid19;
function getFullSerologyTestCovid19LOINC() {
    return [
...
exports.GlobalIndexLOINC = {
    ...
    categorization: {
        ...
        laboratory: {
            covid19LoincGroupCodes: [covid19LaboratoryTestGroups.serologyTestsGroup, covid19LaboratoryTestGroups.naatTestsGroup],
    ...
    groupedCodes: {
        ...
        // It includes not only active / official but deprecated, prerelease, parent groups, groups, amd panels terms
