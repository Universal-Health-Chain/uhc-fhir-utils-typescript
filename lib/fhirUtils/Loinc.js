...
export class Loinc {
    constructor() {
        this.getDisplayCode = (code, englishCodeLabels) => getDisplayCodeLoinc(code, englishCodeLabels);
...
export function getDisplayCodeLoinc(code, englishCodeLabels) {
    if (!englishCodeLabels)
        englishCodeLabels = require("../../languages/en/loincUHC.json");
