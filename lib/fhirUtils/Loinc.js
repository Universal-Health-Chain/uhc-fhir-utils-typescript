...
export class Loinc {
    constructor() {
        ...
        this.healthSections = () => GlobalIndexLOINC.groupedCodes.healthSection.codes;
        this.laboratoryTestTopCommonSI = () => GlobalIndexLOINC.groupedCodes.laboratoryTestTopCommonSI.codes;
...
export var medicalHistoryClassification;
(function (medicalHistoryClassification) {
    ...
    // goals
    // clinicalNotes   
})(medicalHistoryClassification || (medicalHistoryClassification = {}));
export var terminologyCodesLOINC;
...
})(terminologyCodesLOINC || (terminologyCodesLOINC = {}));
export var covid19LaboratoryTestGroups;
...
})(covid19LaboratoryTestGroups || (covid19LaboratoryTestGroups = {}));
...
// display code SHALL ALWAYS BE English (international)
export function getDisplayOrTextByCodeLOINC(code, loincLanguageFile) {
    if (!loincLanguageFile)
        loincLanguageFile = require("../../languages/international/loinc.json");
    return loincLanguageFile[code];
}
export function getActiveLaboratoryTestsCovid19() {
