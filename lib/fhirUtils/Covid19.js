...
function getCovid19DiagnosticReportsInDocument(bundleDoc) {
    let diagnosticReports = Bundle_1.getResourcesByTypesWithOptionalMetadata(bundleDoc, ["DiagnosticReport"]);
...
function getCovid19ImmunizationsInDocument(bundleDoc) {
    let immunizations = Bundle_1.getResourcesByTypesWithOptionalMetadata(bundleDoc, ["Immunization"]);
