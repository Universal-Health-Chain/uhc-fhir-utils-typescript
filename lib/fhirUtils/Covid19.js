...
export class Covid19 {
    constructor() {
        ...
        this.vaccineCodesCovid19 = () => vaccineCodesCovid19();
        ...
        this.laboratoryTestCodes = () => covid19LaboratoryTestsCodes();
        this.laboratoryTestAndGroupsCodes = () => covid19LaboratoryTestsAndGroupsCodes();
...
/** Get LOINC laboratory test group code: serology or naat group code */
const naatTestsGroupCodeLOINC = () => covid19LaboratoryTestGroups.naatTestsGroup;
const serologyTestsGroupCodeLOINC = () => covid19LaboratoryTestGroups.serologyTestsGroup;
/** Get all or specific LOINC laboratory tests */
...
/** Merge codes from distinct systems (if several ones, e.g. for searching) */
export const vaccineCodesCovid19 = () => [...vaccineCodesCVX(), vaccineCodeATC];
const isCovid19Vaccine = (code) => vaccineCodesCovid19().includes(code) ? true : false;
...
export const covid19LaboratoryTestsCodes = () => GlobalIndexLOINC.groupedCodes.laboratoryTestCovid19.codes;
export const covid19LaboratoryTestsAndGroupsCodes = () => [
...
export function getCovid19DiagnosticReportsInDocument(bundleDoc) {
    ...
    const covid19Codes = covid19LaboratoryTestsAndGroupsCodes(); // full COVID-10 laboratory test codes (currently only LOINC codes)
...
export function getCovid19ImmunizationsInDocument(bundleDoc) {
    ...
    const covid19Codes = vaccineCodesCovid19(); // full COVID-10 vaccine codes: ATC and SNOMED codes
