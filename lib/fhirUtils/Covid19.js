...
import { covid19DiseaseTermsSNOMED, getVaccinationProcedureCovid19CodesSNOMED, positiveOrDetectedCodesSNOMED, negativeOrNotDetectedCodesSNOMED, suspectedOrInconclusiveCodesSNOMED, probablyNotPresentCodesSNOMED } from "./Snomed";
...
export class Covid19 {
    constructor() {
        ...
        this.laboratoryTestCodesLOINC = () => GlobalIndexLOINC.groupedCodes.laboratoryTestCovid19.codes;
        this.laboratoryTestCodesSerologyLOINC = () => getFullSerologyTestCovid19LOINC();
        this.laboratoryTestCodesNaatLOINC = () => getFullNaatTestCovid19LOINC();
