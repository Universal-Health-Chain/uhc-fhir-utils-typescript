...
// TODO: urn identifier
export function DocumentReferenceCertificate(documentIdentifier, // universal ID of the document (UUID v4 format), it can have several certified / verifiable versions (VC)
...
documentLanguage, documentTitle, documentDescription, contentTitle, contentFormatURN // URN format defined by IHE or HL7
    ...
    try {
        let fhirAttachment = fhirAttachmentFromBytes(certifiedBytesAsBase64, mimeType);
