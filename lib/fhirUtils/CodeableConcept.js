...
export class CodeableConcept {
    ...
    getSingleCodingInArrayOfCodeableConepts(codeableConcepts, system) {
    ...
    */
    ...
    createCodeableConceptWithLanguageFile(typeCode, codeSystem, customLanguageFile) {
...
/** Coding  */
export function getSingleCodingInArrayOfCodeableConcepts(codeableConcepts, system) {
    let result = {};
    let found = false;
...
export function createCoding(code, system, display, systemVersion, userSelected) {
    let coding = {
        code: code,
        display: display,
        system: system,
...
export function createCodeableConceptWithLanguageFile(typeCode, codeSystem, customLanguageFile, systemVersion, userSelected) {
...
export function createCodeableConcept(typeCode, codeSystem, internationalDisplay, systemVersion, userSelected, customText) {
...
export function createArrayOfCodeableConceptsOfSystem(inputCodes, system, customLanguageFile) {
    ...
    inputCodes.forEach(function (code) {
        let newCodeableConcept = createCodeableConceptWithLanguageFile(code, system, customLanguageFile);
